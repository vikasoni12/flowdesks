...
public class ProcedureResponseFilterSpecification : Specification<Procedure>
{
    public ProcedureResponseFilterSpecification(ProcedureResponsePagingRequest request)
    {
