...
namespace Flowdesks.Domain.Entities.Notifications
{
    public class NotificationSetting : AuditableEntity<Guid>
    {      
        ...
        public bool? IsWorkRequestStatusChanges { get; set; } = true;
